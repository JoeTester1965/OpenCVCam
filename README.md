...
Record multiple cameras and events using ffmpeg and opencv with an optional hailo AI accelerator for object detection and alertng when significant motion has happened in scene.
